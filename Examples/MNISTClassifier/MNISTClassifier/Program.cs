...
namespace MNISTClassifier
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            metricsTrain.ClassesDistribution.ForEach(p => Console.WriteLine($"Class: {p.Index} | Accuracy: {p.Precision:F5} | Fraction: {p.Fraction * 100:F3}"));
            ...
            metricsTest.ClassesDistribution.ForEach(p => Console.WriteLine($"Class: {p.Index} | Accuracy: {p.Precision:F5} | Fraction: {p.Fraction * 100:F3}"));
